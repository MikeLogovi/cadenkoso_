<div id="slider" data-section="home">
		<div class="owl-carousel owl-carousel-fullwidth">
		    ...
		    <div class="item" style="background: #352f44;">
		    	<div class="container" style="position: relative;">
		    		<div class="row">
					    ...
					    <div class="col-md-4 push-md-1 col-sm-4 push-sm-1 iphone-image">
					    	<div class="iphone to-animate-2"><img src="/img/iphone-2.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
					    </div>
		    ...
		    <div class="item" style="background: #38569f;">
		    	<div class="container" style="position: relative;">
		    		<div class="row">
		    			<div class="col-md-7 push-md-1 push-md-5 col-sm-7 push-sm-1 push-sm-5">
			    			<div class="fh5co-owl-text-wrap">
						    	<div class="fh5co-owl-text">
						    		<h1 class="fh5co-lead to-animate">Case Study Title</h1>
									<h2 class="fh5co-sub-lead to-animate">100% Free Fully Responsive HTML5 Bootstrap Template. Crafted with love by the fine folks at <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a></h3>
					    ...
					    <div class="col-md-4 pull-md-7 col-sm-4 pull-sm-7 iphone-image">
					    	<div class="iphone to-animate-2"><img src="/img/iphone-1.png" alt="Free HTML5 Template by FREEHTML5.co"></div>
					    </div>
		    ...
		    <div class="item" style="background-image:url(/img/slide_5.jpg)">
