			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 section-heading text-xs-center">
						<h2 class="to-animate text-center">Meet The Team</h2>
						<div class="row">
							<div class="col-md-8 offset-md-2 subtext">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="team-box text-xs-center to-animate-2">
							<div class="user"><img class="img-reponsive" src="/img/person4.jpg" alt="Roger Garfield"></div>
					...
					<div class="col-md-4">
						<div class="team-box text-xs-center to-animate-2">
							<div class="user"><img class="img-reponsive" src="/img/person2.jpg" alt="Roger Garfield"></div>
							<h3>Kevin Steve</h3>
					...
					<div class="col-md-4">
						<div class="team-box text-xs-center to-animate-2">
							<div class="user"><img class="img-reponsive" src="/img/person3.jpg" alt="Roger Garfield"></div>
